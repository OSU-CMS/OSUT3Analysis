...
MuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Muon Gen. Eta; generated muon #eta"),
        ...
        cms.PSet (
         ...
         cms.PSet (
            ...
            title = cms.string("Muon Iso vs. d_{0}; muon D0; muon Iso"),
        ...
        cms.PSet (
            ...
            title = cms.string("muon Number Of Valid Pixel Hits Vs Muon D0 wrt Beamspot; muon d_{0} [cm]; # pixel hits"),
        ...
        cms.PSet (
            ...
            title = cms.string("Muon d_{0} wrt Vertex vs. Phi; muon #phi; muon d_{0} [cm]"),
        ...
        cms.PSet (
            ...
            title = cms.string("Muon d_{0} Significance; muon d_{0} / #sigma_{d_{0}}"),
        ...
        cms.PSet (
            ...
            title = cms.string("Muon Z Distance to PV; muon #Delta{z} wrt PV [cm]"),
            bins = cms.untracked.vdouble(100, -20, 20),
            inputVariables = cms.vstring("vertexDistZ"),
        ),
        cms.PSet (
            name = cms.string("muonAbsVertexDistZVsMuonAbsD0Beamspot"),
            title = cms.string("Muon Z Distance to PV Vs Muon D0 wrt Beamspot; muon d_{0} [cm]; muon #Delta{z} wrt PV [cm]"),
        ...
        cms.PSet (
            ...
            title = cms.string("Muon Detector-based Isolation; muon rel. iso."),
        ...
        cms.PSet (
            ...
            title = cms.string("Transverse Mass of Muon-MET System; muon-met M_{T} [GeV]"),
...
ElectronHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron d_{0} wrt PV; electron d_{0} [cm]"),
            bins = cms.untracked.vdouble(100, -0.02, 0.02),
            inputVariables = cms.vstring("correctedD0Vertex"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron d_{0} wrt Vertex vs. Phi; electron #phi; electron d_{0} [cm]"),
            bins = cms.untracked.vdouble(100, -3.15, 3.15, 100, -0.02, 0.02),
            inputVariables = cms.vstring("phi","correctedD0Vertex"),
        ),
        cms.PSet (
            name = cms.string("electronAbsD0Vertex"),
            title = cms.string("Electron |d_{0}| wrt Vertex; electron |d_{0}| [cm]"),
            bins = cms.untracked.vdouble(100, 0, 0.02),
            inputVariables = cms.vstring("abs(correctedD0Vertex)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron d_{z}; electron d_{z} [cm]"),
            bins = cms.untracked.vdouble(100, -20, 20),
            inputVariables = cms.vstring("correctedDZ"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron Z Distance to PV; electron #Delta{z} wrt PV [cm]"),
            bins = cms.untracked.vdouble(100, -20, 20),
            inputVariables = cms.vstring("vertexDistZ"),
        ),
        cms.PSet (
            name = cms.string("electronAbsVertexDistZVsElectronAbsD0Beamspot"),
            title = cms.string("Electron Z Distance to PV Vs Electron D0 wrt Beamspot; electron d_{0} [cm]; electron #Delta{z} wrt PV [cm]"),
            bins = cms.untracked.vdouble(100, 0, 0.05, 100, 0, 20),
            inputVariables = cms.vstring("abs(correctedD0)","abs(vertexDistZ)"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Electron Detector-based Isolation; electron rel. iso."),
            bins = cms.untracked.vdouble(100, 0, 3),
            inputVariables = cms.vstring("detIso"),
        ),
        cms.PSet (
        ...
        cms.PSet (
            ...
            title = cms.string("Transverse Mass of Electron-MET System; electron-met M_{T} [GeV]"),
            bins = cms.untracked.vdouble(100, 0, 200),
            inputVariables = cms.vstring("metMT"),
        ),
        cms.PSet (
