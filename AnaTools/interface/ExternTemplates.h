...
extern template class std::_Bvector_base<std::allocator<bool> >;
extern template class std::_Rb_tree<std::string, std::pair<std::string const, std::vector<std::vector<bool, std::allocator<bool> >, std::allocator<std::vector<bool, std::allocator<bool> > > > >, std::_Select1st<std::pair<std::string const, std::vector<std::vector<bool, std::allocator<bool> >, std::allocator<std::vector<bool, std::allocator<bool> > > > > >, std::less<std::string>, std::allocator<std::pair<std::string const, std::vector<std::vector<bool, std::allocator<bool> >, std::allocator<std::vector<bool, std::allocator<bool> > > > > > >;
extern template class std::_Vector_base<std::string, std::allocator<std::string> >;
extern template class std::_Vector_base<std::vector<bool, std::allocator<bool> >, std::allocator<std::vector<bool, std::allocator<bool> > > >;
extern template class std::auto_ptr<std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > >;
...
extern template class std::pair<std::string, double>;
...
extern template edm::OrphanHandle<std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > > edm::Event::put<std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > >(std::auto_ptr<std::map<std::string, double, std::less<std::string>, std::allocator<std::pair<std::string const, double> > > >, std::string const&);
...
extern template std::_List_node<edm::ProductRegistryHelper::TypeLabelItem>* std::list<edm::ProductRegistryHelper::TypeLabelItem, std::allocator<edm::ProductRegistryHelper::TypeLabelItem> >::_M_create_node<edm::BranchType, edm::TypeID const&, std::string const&>(edm::BranchType&&, edm::TypeID const&, std::string const&);
extern template std::_Rb_tree_iterator<std::pair<std::string const, double> > std::_Rb_tree<std::string, std::pair<std::string const, double>, std::_Select1st<std::pair<std::string const, double> >, std::less<std::string>, std::allocator<std::pair<std::string const, double> > >::_M_insert_<std::pair<std::string, double> >(std::_Rb_tree_node_base const*, std::_Rb_tree_node_base const*, std::pair<std::string, double>&&);
extern template std::_Rb_tree_iterator<std::pair<std::string const, double> > std::_Rb_tree<std::string, std::pair<std::string const, double>, std::_Select1st<std::pair<std::string const, double> >, std::less<std::string>, std::allocator<std::pair<std::string const, double> > >::_M_insert_unique_<std::pair<std::string, double> >(std::_Rb_tree_const_iterator<std::pair<std::string const, double> >, std::pair<std::string, double>&&);
extern template std::basic_string<char, std::char_traits<char>, std::allocator<char> > std::operator+<char, std::char_traits<char>, std::allocator<char> >(char const*, std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&);
extern template std::basic_string<char, std::char_traits<char>, std::allocator<char> > std::operator+<char, std::char_traits<char>, std::allocator<char> >(char const*, std::basic_string<char, std::char_traits<char>, std::allocator<char> >&&);
extern template std::basic_string<char, std::char_traits<char>, std::allocator<char> > std::operator+<char, std::char_traits<char>, std::allocator<char> >(std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, char const*);
...
extern template std::basic_string<char, std::char_traits<char>, std::allocator<char> > std::operator+<char, std::char_traits<char>, std::allocator<char> >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >&&, std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&);
extern template std::basic_string<char, std::char_traits<char>, std::allocator<char> > std::operator+<char, std::char_traits<char>, std::allocator<char> >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >&&, std::basic_string<char, std::char_traits<char>, std::allocator<char> >&&);
extern template std::pair<std::_Rb_tree_iterator<std::pair<std::string const, double> >, bool> std::_Rb_tree<std::string, std::pair<std::string const, double>, std::_Select1st<std::pair<std::string const, double> >, std::less<std::string>, std::allocator<std::pair<std::string const, double> > >::_M_insert_unique<std::pair<std::string, double> >(std::pair<std::string, double>&&);
extern template std::string* std::__uninitialized_copy<false>::__uninit_copy<__gnu_cxx::__normal_iterator<std::string const*, std::vector<std::string, std::allocator<std::string> > >, std::string*>(__gnu_cxx::__normal_iterator<std::string const*, std::vector<std::string, std::allocator<std::string> > >, __gnu_cxx::__normal_iterator<std::string const*, std::vector<std::string, std::allocator<std::string> > >, std::string*);
...
extern template void std::_Destroy_aux<false>::__destroy<std::string*>(std::string*, std::string*);
