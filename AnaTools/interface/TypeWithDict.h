#ifndef OSUT3Analysis_AnaTools_TypeWithDict_h
#define OSUT3Analysis_AnaTools_TypeWithDict_h
...
private:
  ...
  TEnum* enum_;
  TDataType* dataType_;
  edm::value_ptr<std::vector<size_t> > arrayDimensions_;
  long property_;
public:
...
#endif // OSUT3Analysis_AnaTools_TypeWithDict_h
