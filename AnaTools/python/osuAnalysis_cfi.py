...
#    treeBranchSets = AllTreeBranchSets,
    ...
    #trackingScaleFactor = cms.double(0.9) random number for now
    ...
    printEventInfo   = cms.bool(True),  # produces a lot of output, recommend using only with few channels and histograms
