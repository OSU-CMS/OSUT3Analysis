...
#    treeBranchSets = AllTreeBranchSets,
    ...
    electronSFFile = cms.string (''), # if blank, will attempt to use the SFs hard-coded in SFWeight.h
    ...
    electronSFID = cms.string ('mvaTrig0p9'), # ID label for using hard-coded SFs in SFWeight.h
    ...
    trackingScaleFactor = cms.double(1.0), #random number for now
    ...
    muonSFShift = cms.string('whatever'), # change to 'up' to shift factors up 1 sigma, to 'down' to shift factors down 1 sigma 
