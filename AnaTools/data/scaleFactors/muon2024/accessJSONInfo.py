...
# In 2024 the Trig corrections were moved to another file https://gitlab.cern.ch/cms-muonPOG/muonefficiencies/-/tree/master/Run3/2024/2024_Z/HLT/json?ref_type=heads
fname = "ScaleFactors_Muon_Z_HLT_2024_eta_pt_schemaV2.flowfix.json"
...
makeJSON(evaluator,trigNames,ptRangeTrig,etaRange,"Run2024_SF_Trig.json") # Creating trigger JSON
