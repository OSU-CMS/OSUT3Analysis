...
makeJSON(evaluator,idNames,ptRangeIDIso,etaRange,"RunC_SF_ID.json") # Creating ID JSON
makeJSON(evaluator,isoNames,ptRangeIDIso,etaRange,"RunC_SF_ISO.json") # Creating ISO JSON
makeJSON(evaluator,trigNames,ptRangeTrig,etaRange,"RunC_SF_Trig.json") # Creating trigger JSON