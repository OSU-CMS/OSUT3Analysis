...
makeJSON(evaluator,idNames,ptRangeIDIso,etaRange,"RunCD_SF_ID.json") # Creating ID JSON
makeJSON(evaluator,isoNames,ptRangeIDIso,etaRange,"RunCD_SF_ISO.json") # Creating ISO JSON
makeJSON(evaluator,trigNames,ptRangeTrig,etaRange,"RunCD_SF_Trig.json") # Creating trigger JSON