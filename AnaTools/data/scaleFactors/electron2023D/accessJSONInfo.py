...
def combineRecoPlots():
    ...
    f_low = TFile.Open('egammaEffiLowPtRECO.txt_EGM2D.root', 'READ')
    f_med = TFile.Open('egammaEffiMidPtRECO.txt_EGM2D.root', 'READ')
    f_high = TFile.Open('egammaEffiHighPtRECO.txt_EGM2D.root', 'READ')
