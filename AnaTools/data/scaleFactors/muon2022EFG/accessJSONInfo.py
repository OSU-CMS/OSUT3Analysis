...
makeJSON(evaluator,idNames,ptRangeIDIso,etaRange,"RunEFG_SF_ID.json") # Creating ID JSON
makeJSON(evaluator,isoNames,ptRangeIDIso,etaRange,"RunEFG_SF_ISO.json") # Creating ISO JSON
makeJSON(evaluator,trigNames,ptRangeTrig,etaRange,"RunEFG_SF_Trig.json") # Creating trigger JSON