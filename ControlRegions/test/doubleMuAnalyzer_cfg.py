...
process.OSUAnalysis.channels.append(ZtoTauTautoMuMu_Selection)
process.OSUAnalysis.channels.append(WWtoMuMu_Selection)
process.OSUAnalysis.channels.append(WZtoMuMuMu_Selection)
process.OSUAnalysis.channels.append(ZZtoMuMuMuMu_Selection)
process.OSUAnalysis.channels.append(TTbartoMuMu_Selection)
process.OSUAnalysis.channels.append(QCDtoMuMu_Selection)
